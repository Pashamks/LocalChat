...
namespace ChatClient.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SentMsg")]
        void SentMsg(string msg, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SentMsg")]
        System.Threading.Tasks.Task SentMsgAsync(string msg, int id);
    }
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat {
        ...
        public void SentMsg(string msg, int id) {
            base.Channel.SentMsg(msg, id);
        }
        
        public System.Threading.Tasks.Task SentMsgAsync(string msg, int id) {
            return base.Channel.SentMsgAsync(msg, id);
        }
    }
}
